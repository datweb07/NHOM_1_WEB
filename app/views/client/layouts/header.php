...
<header class="sticky-header">
                    ...
                    <div class="mega-menu">
                        ...
                        <div class="mega-col">
                            ...
                            <a href="#" class="hot-item">
                                <img src="<?= ASSET_URL ?>/assets/client/images/navbar/1.png" alt="">
                                <div>
                            ...
                            <a href="#" class="hot-item">
                                <img src="<?= ASSET_URL ?>/assets/client/images/navbar/2.png" alt="">
                                <div>
                                    <div class="hot-item-name">OPPO A55 4GB-64GB</div>
                                    <div class="hot-item-price">4.990.000 ₫</div>
                                </div>
                            </a>
                            <div class="mega-banner"><a href="#"><img src="<?= ASSET_URL ?>/assets/client/images/navbar/3.png"
                                        alt=""></a></div>
                        </div>
                    </div>
                </li>
                    ...
                    <div class="mega-menu">
                        ...
                        <div class="mega-col">
                            <div class="mega-banner" style="margin-top:0">
                                <a href="#"><img src="<?= ASSET_URL ?>/assets/client/images/navbar/4.png" alt=""></a>
                            </div>
                        </div>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <div class="mega-menu">
                        ...
                        <div class="mega-col">
                            <div class="mega-section-title">Bán chạy nhất</div>
                            <a href="#" class="hot-item">
                                <img src="<?= ASSET_URL ?>/assets/client/images/navbar/5.png" alt="">
                                <div>
                            ...
                            <a href="#" class="hot-item">
                                <img src="<?= ASSET_URL ?>/assets/client/images/navbar/6.png" alt="">
                                <div>
                                    <div class="hot-item-name">Samsung Galaxy Tab S6 Lite 2022</div>
                                    <div class="hot-item-price">7.990.000 ₫</div>
                                </div>
                            </a>
                            <div class="mega-banner"><a href="#"><img src="<?= ASSET_URL ?>/assets/client/images/navbar/7.png"
                                        alt=""></a></div>
                        </div>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <div class="mega-menu">
                        ...
                        <div class="mega-col">
                            <div class="mega-section-title">Bán chạy nhất</div>
                            <a href="#" class="hot-item">
                                <img src="<?= ASSET_URL ?>/assets/client/images/navbar/8.png" alt="">
                                <div>
                            ...
                            <a href="#" class="hot-item">
                                <img src="<?= ASSET_URL ?>/assets/client/images/navbar/9.png" alt="">
                                <div>
                                    <div class="hot-item-name">iPhone 13 128GB</div>
                                    <div class="hot-item-price">19.490.000 ₫</div>
                                </div>
                            </a>
                            <div class="mega-banner"><a href="#"><img src="<?= ASSET_URL ?>/assets/client/images/navbar/10.png"
                                        alt=""></a></div>
                        </div>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <div class="mega-menu">
                        ...
                        <div class="mega-col">
                            <div class="mega-section-title">Bán chạy nhất</div>
                            <a href="#" class="hot-item">
                                <img src="<?= ASSET_URL ?>/assets/client/images/navbar/11.png" alt="">
                                <div>
                            ...
                            <a href="#" class="hot-item">
                                <img src="<?= ASSET_URL ?>/assets/client/images/navbar/12.png" alt="">
                                <div>
                                    <div class="hot-item-name">Pin sạc dự phòng UmeTravel 10000mAh</div>
                                    <div class="hot-item-price">809.000 ₫</div>
                                </div>
                            </a>
                            <div class="mega-banner"><a href="#"><img src="<?= ASSET_URL ?>/assets/client/images/navbar/13.png"
                                        alt=""></a></div>
                        </div>
                    </div>
                </li>
    ...
    <div class="offcanvas offcanvas-start" tabindex="-1" id="mobileMenu">
        <div class="offcanvas-header">
            <a href="/" style="display:inline-block; line-height:0;">
                <img src="<?= ASSET_URL ?>/assets/client/images/header/3.png"
                     alt="FPT Shop"
