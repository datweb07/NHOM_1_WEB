...
// Giả sử $sanPham, $phienBans, $hinhAnhs, $danhGias được truyền từ controller
?>
...
<div class="container mt-4">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <?php if (isset($sanPham['ten_danh_muc'])): ?>
                <li class="breadcrumb-item"><a href="/san-pham?danh_muc=<?= $sanPham['danh_muc_id'] ?>"><?= htmlspecialchars($sanPham['ten_danh_muc']) ?></a></li>
            <?php endif; ?>
    ...
    <div class="row">
        ...
        <div class="col-md-5">
            <div class="card">
                <img src="<?= $hinhAnhs[0]['url_anh'] ?? '/assets/images/no-image.png' ?>" 
                     class="card-img-top" 
                     id="main-image"
    ...
    <div class="mt-4">
        <ul class="nav nav-tabs" role="tablist">
            <li class="nav-item">
                <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#thong-so">Thông số kỹ thuật</button>
            </li>
            <li class="nav-item">
                <button class="nav-link" data-bs-toggle="tab" data-bs-target="#danh-gia">Đánh giá (<?= $tongDanhGia ?? 0 ?>)</button>
            </li>
        </ul>
                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            ...
                            <form id="form-danh-gia">
                                ...
                                <div class="mb-3">
                                    <textarea class="form-control" name="noi_dung" rows="3" placeholder="Nhận xét của bạn..." required></textarea>
                                </div>
                            ...
                            <div class="card mb-2">
                                <div class="card-body">
                                    <div class="d-flex align-items-center mb-2">
                                        ...
                                        <small class="text-muted ms-auto"><?= date('d/m/Y', strtotime($dg['ngay_viet'])) ?></small>
                                    </div>
