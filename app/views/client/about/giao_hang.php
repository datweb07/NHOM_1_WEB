...
<style>
    ...
    .content-section.large-text .policy-card-title { font-size: 20px; }
</style>
    ...
    <div class="row">
        ...
        <div class="col-lg-9 col-md-8">
            <div class="content-section" id="policy-content">
                ...
                <p class="intro-text">Mua hàng tại FPT Shop, khách hàng sẽ được hỗ trợ giao hàng tại nhà hầu như trên toàn quốc. Với độ phủ trên khắp 63 tỉnh thành, Quý khách sẽ nhận được sản phẩm nhanh chóng mà không cần mất thời gian di chuyển tới cửa hàng.</p>
                ...
                <div class="policy-card">
                    ...
                    <div class="policy-card-body">
                        <ul>
                            <li>Áp dụng với tất cả các sản phẩm có áp dụng giao hàng tại nhà, không giới hạn giá trị.</li>
                            <li>Miễn phí giao hàng trong bán kính 20km có đặt shop (Đơn hàng giá trị < 100.000 VNĐ thu phí 10.000 VNĐ).</li>
                            <li>Với khoảng cách lớn hơn 20km, nhân viên FPT Shop sẽ tư vấn chi tiết về cách thức giao nhận thuận tiện nhất.</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="policy-card">
                    ...
                    <div class="policy-card-body">
                        <ul>
                            <li><strong>Đơn hàng có giá trị từ 50 triệu trở lên:</strong> Quý khách phải thanh toán trước 100% giá trị đơn hàng nếu muốn giao hàng tại nhà.</li>
                            <li><strong>Đơn hàng có giá trị dưới 50 triệu:</strong> Quý khách có thể nhận hàng và thanh toán tại nhà khi đồng ý mua hàng.</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="policy-card warning-card mt-4">
                    ...
                    <div class="policy-card-body">
                        <ul>
                            <li>Khi nhận hàng, quý khách không đồng kiểm chi tiết với nhà vận chuyển (chỉ kiểm tra ngoại quan kiện hàng, không bóc và kiểm tra chi tiết sản phẩm bên trong). Trường hợp Quý khách không nhận sản phẩm, kiện hàng sẽ được nhà vận chuyển chuyển hoàn về nơi gửi.</li>
                            <li>Quý khách cần quay video khi nhận hàng mở kiện để được thực hiện đổi trả nếu hàng hoá có phát sinh vấn đề.</li>
                            <li>Quý khách có 01 ngày để gọi lên tổng đài khiếu kiện trong trường hợp phát sinh đến hàng hoá.</li>
                        </ul>
                    </div>
                </div>
