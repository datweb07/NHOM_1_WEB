    ...
    <div class="row">
        ...
        <div class="col-lg-9 col-md-8">
            <div class="content-section" id="policy-content">
                ...
                <h5>2.1. Chính sách đổi trả sản phẩm ICT các hãng: Điện thoại, Máy tính bảng, Máy tính xách tay, PC đồng bộ, PC AIO, Đồng hồ thông minh, Vòng đeo tay thông minh, Màn hình</h5>
                    ...
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th style="width: 25%;">Phí khấu hao khi trả hàng (dựa trên giá trị sản phẩm trên đơn hàng)</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    ...
                                    Nếu sản phẩm đổi hết hàng, khách hàng có thể đổi sang một sản phẩm khác tương đương hoặc cao hơn về giá trị so với sản phẩm lỗi.<br><br>
                                    Khách hàng muốn trả sản phẩm: FPT Shop sẽ kiểm tra tình trạng máy và thông báo đến KH về giá trị thu lại sản phẩm theo quy định.
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="text-center fw-bold text-danger">30% trong tháng đầu tiên, mỗi tháng tiếp theo tính thêm 5%/Tháng</td>
                            </tr>
                            <tr>
                ...
                <ul>
                    <li><strong>Phí trầy xước:</strong><br>
                        + Trầy xước mức độ 1 (Xước nhẹ, nhỏ (<=0,5cm), ít (<=2 điểm) tại vị trí khuất (đáy/cạnh laptop, xước dăm viền điện thoại): 0%<br>
                        + Trầy xước mức độ 2 (Xước >0,5cm hoặc >=3 điểm tại vị trí khuất hoặc có xước tại vị trí dễ nhìn thấy (bàn phím laptop, mặt lưng điện thoại, …): 10% (ngoại trừ phụ kiện, dịch vụ, Điện máy, sản phẩm thiết bị dịch vụ)<br>
                    ...
                    <li><strong>Phí hóa đơn công ty nếu không có biên bản điều chỉnh:</strong> 10% (Trả hàng trong 30 ngày).</li>
                    <li>Số tiền tương đương giá trị quà tặng khuyến mãi đi kèm nếu không được hoàn trả.</li>
                </ul>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    ...
                                    Nếu không có sản phẩm tương đương, FPT Shop hoàn lại tiền 100% giá trị sản phẩm (áp dụng các phí khác nếu có tương tự máy mới).
                                </td>
                            </tr>
                            <tr>
                ...
                <p class="fw-bold">2.2.1. Gia dụng có điện có chính sách bảo hành tại Trạm: bao gồm bếp gas (trừ Kangaroo, Gold sun), Camera</p>
                <div class="table-container">
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="text-center">0 - 30 ngày</td>
                                <td>“Hư gì đổi nấy” - 1 ĐỔI 1 đối với bộ phận lỗi<br>(cùng model, cùng màu, cùng cấu hình)</td>
                            </tr>
                            <tr>
                ...
                <p class="fw-bold">2.2.2. Gia dụng có điện có chính sách bảo hành tại Nhà; VD: máy lọc nước, quạt điều hòa trừ Magic, Magic ECO; bếp ga Kangaroo, Goldsun; Bếp từ đa vùng nấu;…</p>
                <div class="table-container">
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="text-center">0 - 30 ngày</td>
                                <td>
                                    “Hư gì đổi nấy” - 1 ĐỔI 1 đối với bộ phận lỗi sau khi có xác nhận của Kỹ thuật viên kiểm tra tại nhà KH<br>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>FPT Shop sẽ kiểm tra tình trạng sản phẩm và thông báo đến Khách hàng về giá trị thu lại sản phẩm ngay tại cửa hàng.</td>
                            </tr>
                            <tr>
                                <td class="fw-bold text-center">Lỗi người dùng</td>
                                <td class="text-center">Đến khi hết hạn bảo hành</td>
                ...
                <p><strong>Lưu ý:</strong><br>Phí đổi trả khác nếu có: FPT Shop sẽ kiểm tra tình trạng máy và thông báo đến khách hàng về mức phí phải thu ngay tại cửa hàng</p>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    ...
                                    Đối với sản phẩm máy chiếu hãng Beecube: Hãng bảo hành đổi mới trong 12 tháng, bao gồm thân máy và phụ kiện (điều khiển, Adapter).
                                </td>
                            </tr>
                            <tr>
                                <td class="fw-bold text-center">Đổi trả theo nhu cầu</td>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <strong>Hãng Casper và Midea:</strong> FPT Shop Miễn phí 1 đổi 1 sản phẩm cùng model đối với sản phẩm có lỗi.<br>
                                ...
                                <td>
                                    ...
                                    FPT Shop thực hiện 1 đổi 1 tại nhà cho KH khi KH cung cấp biên bản xác nhận lỗi của Hãng (Hiệu lực của biên bản trong vòng 7 ngày kể từ ngày lập).<br><br>
                                    KH liên hệ hotline hãng hoặc hotline FPT Shop để yêu cầu bảo hành/sửa chữa. Hãng sẽ điều kỹ thuật xuống kiểm tra và xử lý cho KH tại nhà.
                                </td>
                            </tr>
                            <tr>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    ...
                                    Nếu sản phẩm đổi hết hàng, khách hàng có thể đổi sang một sản phẩm khác tương đương hoặc cao hơn về giá trị so với sản phẩm lỗi.
                                </td>
                            </tr>
                            <tr>
                                <td class="text-center">Từ ngày 31 đến khi hết hạn bảo hành</td>
                            ...
                            <tr>
                                <td class="fw-bold text-center">Lỗi người dùng</td>
                                <td class="text-center">Đến khi hết hạn bảo hành</td>
                                <td>FPT Shop hỗ trợ điều động kỹ thuật hãng tới sửa chữa tại nhà, khách hàng trả phí sửa.</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    KH liên hệ hotline Hãng hoặc hotline FPT Shop để kỹ thuật hãng kiểm tra tại nhà.<br>
                                    FPT Shop thực hiện 1 đổi 1 tại nhà cho KH khi KH cung cấp biên bản xác nhận lỗi của Hãng (Hiệu lực của biên bản trong vòng 7 ngày kể ngày lập)<br><br>
                                    KH liên hệ hotline Hãng hoặc hotline FPT Shop để yêu cầu bảo hành/ sửa chữa. Hãng sẽ điều kỹ thuật xuống kiểm tra và xử lý cho KH tại nhà.
                                </td>
                            </tr>
                            <tr>
                ...
                <div class="table-container">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <tr>
                                <td rowspan="2" class="fw-bold">Thiết bị mạng, Ổ cứng di động, USB, Thẻ nhớ, Sạc, Cáp, Sạc dự phòng, Chuột, Phụ kiện laptop, Tai nghe, Loa, thiết bị Giải trí (trừ hãng Marshall, JBL, Harman kardon, SONY), Combo phụ kiện, Sạc, Tai nghe có dây, đế sạc không dây, Sạc dự phòng thuộc Samsung</td>
                                <td class="text-center">0 - 365 ngày</td>
                                ...
                                <td>
                                    ...
                                    Trường hợp hết mã cùng loại hoặc cùng nhóm hàng để đổi hoặc hết hàng FPT Shop hỗ trợ đổi sang mã khác theo nhu cầu của KH.
                                </td>
                            </tr>
                            <tr>
                                <td class="text-center">0 - 365 ngày</td>
                            ...
                            <tr>
                                <td class="fw-bold">Máy chơi game Sony PlayStation; PKNK (trừ bao da, ốp lưng, dây đeo đồng hồ); Tai nghe, loa thuộc hãng Marshall, JBL, Harman Kardon, SONY</td>
                                <td class="text-center">Đến khi hết hạn bảo hành</td>
                                <td class="text-center">Lỗi nhà sản xuất</td>
                                <td>Không đổi trả, FPT Shop hỗ trợ gửi máy đi bảo hành theo chính sách hãng.</td>
                            </tr>
                            ...
                            <tr>
                                <td class="fw-bold">Ốp lưng, Bao da, balo,túi xách, túi chống sốc, túi chống nước, gậy chụp hình, tay cầm chơi game, dây đồng hồ, Miếng dán màn hình lẻ và combo miếng dán 2 mặt (dành cho ĐTDĐ)</td>
                            ...
                            <tr>
                                <td class="fw-bold">MDMH lẻ và combo miếng dán 2 mặt (dành cho MTB, MTXT), MDMH Kính cường lực</td>
                ...
                <div class="table-container">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="fw-bold">Các gói bảo hành Bolttech:<br>- Bảo hành mở rộng<br>- Bảo hành đặc quyền đổi mới 12 tháng<br>- Bảo hành VIP 1 đổi 1<br>- Bảo hành rơi vỡ vào nước<br>- Bảo hành đặc quyền thay pin trong 3 năm</td>
