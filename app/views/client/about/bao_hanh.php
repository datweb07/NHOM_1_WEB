        ...
        <div class="col-lg-9 col-md-8">
            <div class="content-section" id="policy-content">
                ...
                <div class="mt-4 border-top pt-3">
                    <p class="footnote">(*) Áp dụng với các sản phẩm bán mới hoặc còn hạn bảo hành mặc định nếu đã qua sử dụng.</p>
                    <p class="footnote">(**) Áp dụng với các sản phẩm thuộc diện đổi mới trong 30 ngày nếu có lỗi NSX được công bố trên website <a href="#">Chính sách đổi trả</a>.</p>
                    <p class="footnote">(***) Trừ các sản phẩm có chính sách bảo hành tại nhà, sản phẩm thuộc diện cồng kềnh.</p>
                </div>
