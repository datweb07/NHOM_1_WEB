...
<div class="container my-3">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb breadcrumb-custom">
            ...
            <li class="breadcrumb-item active" aria-current="page">Chính sách giao hàng & lắp đặt Điện máy chỉ bán online</li>
        </ol>
    </nav>
    ...
    <div class="row">
        ...
        <div class="col-lg-9 col-md-8">
            <div class="content-section" id="policy-content">
                ...
                <ul>
                    <li><strong>Phạm vi giao hàng:</strong> TP.Hồ Chí Minh, Tỉnh Đồng Nai, Tỉnh An Giang, TP. Đà Nẵng, TP. Hà Nội, TP. Hải Phòng, Tỉnh Bắc Ninh</li>
                    <li><strong>Chi phí giao hàng:</strong> Miễn phí.</li>
                    <li><strong>Thời gian giao hàng:</strong> 24 - 48 giờ tính từ thời điểm khách đặt hàng (hoặc theo thoả thuận với khách hàng).</li>
                    <li><strong>Áp dụng riêng Tivi thương hiệu VSP:</strong> hỗ trợ giao hàng miễn phí toàn quốc</li>
                </ul>

                <h4>2. Chính sách lắp đặt</h4>
                <p><strong>Phạm vi áp dụng:</strong> TP.Hồ Chí Minh, Tỉnh Đồng Nai, Tỉnh An Giang, TP. Đà Nẵng, TP. Hà Nội, TP. Hải Phòng, Tỉnh Bắc Ninh</p>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td rowspan="3" class="text-center align-middle text-success fw-bold" style="width: 25%;">Lắp đặt miễn phí</td>
                            </tr>
                            <tr>
                ...
                <p>Các sản phẩm <strong>Điện máy Chỉ bán Online</strong> có ưu đãi dành riêng cho các khách hàng khu vực TP.Hồ Chí Minh, Đồng Nai, Bình Dương, Bà Rịa Vũng Tàu. Để nhận được ưu đãi giá bán tốt nhất quý khách có thể thực hiện như sau:</p>
                <ul>
