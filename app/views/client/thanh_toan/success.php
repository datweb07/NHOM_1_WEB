                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body p-4">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8 fw-bold text-danger"><?= htmlspecialchars($donHang['ma_don_hang'] ?? '') ?></div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8 text-success">-<?= number_format($donHang['tien_giam_gia'], 0, ',', '.') ?>đ</div>
                        </div>
                        <?php endif; ?>
                        
                        <div class="row mb-3">
                            <div class="col-sm-4 text-muted">Tổng thanh toán:</div>
                            <div class="col-sm-8 fw-bold text-danger fs-5"><?= number_format($donHang['tong_thanh_toan'] ?? 0, 0, ',', '.') ?>đ</div>
                        </div>
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="d-flex align-items-center gap-3 mb-3 pb-3 border-bottom">
                            <div style="width:60px;height:60px;border:1px solid #eee;border-radius:4px;overflow:hidden;">
                                <img src="<?= ASSET_URL ?>/assets/client/images/products/default.png" 
