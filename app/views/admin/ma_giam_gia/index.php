                    ...
                    <div class="card">
                            ...
                            <div class="row g-3">
                                <div class="col-md-4">
                                    ...
                                    <select name="trang_thai" id="trang_thai" class="form-select">
                                        ...
                                        <option value="HET_LUOT" <?= $trangThai === 'HET_LUOT' ? 'selected' : '' ?>>Hết lượt</option>
                                    </select>
                                </div>
                                                ...
                                                <td>
                                                    <?php if ($ma['loai_giam'] === 'PHAN_TRAM'): ?>
                                                        ...
                                                        <?php if ($ma['giam_toi_da']): ?>
                                                            <br><small>(Tối đa: <?= number_format($ma['giam_toi_da'], 0) ?>đ)</small>
                                                        <?php endif; ?>
                                                    <?php else: ?>
                        ...
                        <?php if ($totalPages > 1): ?>
                            <nav aria-label="Page navigation">
                                <ul class="pagination justify-content-center">
                                    <?php if ($currentPage > 1): ?>
                                        <li class="page-item">
                                            <a class="page-link" href="?page=<?= $currentPage - 1 ?><?= $trangThai ? '&trang_thai=' . urlencode($trangThai) : '' ?>">
                                                Trước
                                            </a>
                                        </li>
                                    <?php endif; ?>
                                    ...
                                    <?php for ($i = 1; $i <= $totalPages; $i++): ?>
                                        <li class="page-item <?= $i === $currentPage ? 'active' : '' ?>">
                                            <a class="page-link" href="?page=<?= $i ?><?= $trangThai ? '&trang_thai=' . urlencode($trangThai) : '' ?>">
                                                <?= $i ?>
                                            </a>
                                        </li>
                                    <?php endfor; ?>
                            ...
                            <p class="text-center text-muted">
                                Hiển thị <?= ($currentPage - 1) * $limit + 1 ?> - <?= min($currentPage * $limit, $totalMaGiamGia) ?> 
