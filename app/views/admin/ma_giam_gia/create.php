                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input 
                                            ...
                                            id="ma_code" 
                                            name="ma_code" 
                                            value="<?= htmlspecialchars($old['ma_code'] ?? '') ?>"
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        >
                                            ...
                                            <option value="PHAN_TRAM" <?= ($old['loai_giam'] ?? '') === 'PHAN_TRAM' ? 'selected' : '' ?>>Phần trăm</option>
                                            <option value="SO_TIEN" <?= ($old['loai_giam'] ?? '') === 'SO_TIEN' ? 'selected' : '' ?>>Số tiền</option>
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input 
                                            ...
                                            id="gia_tri_giam" 
                                            name="gia_tri_giam" 
                                            value="<?= htmlspecialchars($old['gia_tri_giam'] ?? '') ?>"
                                        >
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input 
                                            ...
                                            id="giam_toi_da" 
                                            name="giam_toi_da" 
                                            value="<?= htmlspecialchars($old['giam_toi_da'] ?? '') ?>"
                                        >
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input 
                                            ...
                                            id="don_toi_thieu" 
                                            name="don_toi_thieu" 
                                            value="<?= htmlspecialchars($old['don_toi_thieu'] ?? '0') ?>"
                                        >
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input 
                                            ...
                                            value="<?= htmlspecialchars($old['gioi_han_su_dung'] ?? '') ?>"
                                        >
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input 
                                            ...
                                            id="ngay_bat_dau" 
                                            name="ngay_bat_dau" 
                                            value="<?= htmlspecialchars($old['ngay_bat_dau'] ?? '') ?>"
                                        >
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input 
                                            ...
                                            id="ngay_ket_thuc" 
                                            name="ngay_ket_thuc" 
                                            value="<?= htmlspecialchars($old['ngay_ket_thuc'] ?? '') ?>"
                                        >
