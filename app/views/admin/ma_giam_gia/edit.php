            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title mb-0">Sửa Mã Giảm Giá: <?= htmlspecialchars($maGiamGia['ma_code']) ?></h3>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="/admin/ma-giam-gia/sua?id=<?= $maGiamGia['id'] ?>">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        >
                                        <small class="form-text text-muted">Chỉ chữ in hoa và số, tối đa 50 ký tự</small>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        >
                                            ...
                                            <option value="PHAN_TRAM" <?= ($old['loai_giam'] ?? $maGiamGia['loai_giam']) === 'PHAN_TRAM' ? 'selected' : '' ?>>Phần trăm</option>
                                            <option value="SO_TIEN" <?= ($old['loai_giam'] ?? $maGiamGia['loai_giam']) === 'SO_TIEN' ? 'selected' : '' ?>>Số tiền</option>
                                        </select>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        >
                                        <small class="form-text text-muted">Nếu phần trăm: 0-100, nếu số tiền: giá trị VNĐ</small>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        >
                                        <small class="form-text text-muted">Để trống nếu không giới hạn. Đã dùng: <?= $maGiamGia['so_luot_da_dung'] ?></small>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea 
                                    class="form-control <?= isset($errors['mo_ta']) ? 'is-invalid' : '' ?>" 
                                    id="mo_ta" 
                                    name="mo_ta" 
                                    rows="3"
                                ><?= htmlspecialchars($old['mo_ta'] ?? $maGiamGia['mo_ta'] ?? '') ?></textarea>
