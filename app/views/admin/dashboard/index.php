      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-6">
          ...
          <div class="small-box text-bg-primary">
            ...
            <a href="/admin/don-hang" class="small-box-footer link-light link-underline-opacity-0 link-underline-opacity-50-hover">
        ...
        <div class="col-lg-3 col-6">
          ...
          <div class="small-box text-bg-success">
            ...
            <a href="/admin/nguoi-dung" class="small-box-footer link-light link-underline-opacity-0 link-underline-opacity-50-hover">
              Xem chi tiết <i class="bi bi-link-45deg"></i>
            </a>
          </div>
        ...
        <div class="col-lg-3 col-6">
          ...
          <div class="small-box text-bg-warning">
            ...
            <a href="/admin/san-pham" class="small-box-footer link-dark link-underline-opacity-0 link-underline-opacity-50-hover">
              Xem chi tiết <i class="bi bi-link-45deg"></i>
            </a>
          </div>
        ...
        <div class="col-lg-3 col-6">
          ...
          <div class="small-box text-bg-danger">
            ...
            <a href="/admin/thanh-toan" class="small-box-footer link-light link-underline-opacity-0 link-underline-opacity-50-hover">
              Xem chi tiết <i class="bi bi-link-45deg"></i>
            </a>
          </div>
                ...
                <div class="col-md-6">
                  <div class="info-box">
                    ...
                    <div class="info-box-content">
                      ...
                      <span class="info-box-number"><?= htmlspecialchars($monthlyOrders ?? 0) ?></span>
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="info-box">
                    ...
                    <div class="info-box-content">
                      ...
                      <span class="info-box-number"><?= number_format($monthlyRevenue ?? 0, 0, ',', '.') ?> ₫</span>
                    </div>
                  </div>
                </div>
              </div>
