            ...
            <div class="card">
                ...
                <form class="row g-3" method="POST" action="/admin/san-pham/sua?id=<?= $sanPhamId ?>">
                    <div class="col-12">
                        ...
                        <?php if (!empty($errors['ten_san_pham'])): ?><div class="text-danger small mt-1"><?= SanPhamEditViewHelper::e($errors['ten_san_pham']) ?></div><?php endif; ?>
                    </div>

                    <div class="col-12 col-md-6">
                        <label class="form-label" for="slug">Slug</label>
                        <input class="form-control" id="slug" name="slug" type="text" value="<?= SanPhamEditViewHelper::e($old['slug'] ?? $sanPham['slug'] ?? '') ?>" placeholder="vi-du: iphone-16-pro-max">
                        <?php if (!empty($errors['slug'])): ?><div class="text-danger small mt-1"><?= SanPhamEditViewHelper::e($errors['slug']) ?></div><?php endif; ?>
                    </div>

                    <div class="col-12 col-md-6">
                        <label class="form-label" for="hang_san_xuat">Hãng sản xuất</label>
                        <input class="form-control" id="hang_san_xuat" name="hang_san_xuat" type="text" value="<?= SanPhamEditViewHelper::e($old['hang_san_xuat'] ?? $sanPham['hang_san_xuat'] ?? '') ?>" placeholder="Apple, Samsung, Xiaomi...">
                        <?php if (!empty($errors['hang_san_xuat'])): ?><div class="text-danger small mt-1"><?= SanPhamEditViewHelper::e($errors['hang_san_xuat']) ?></div><?php endif; ?>
                    </div>

                    <div class="col-12">
                        <label class="form-label" for="mo_ta">Mô tả</label>
                        <textarea class="form-control" id="mo_ta" name="mo_ta" rows="4"><?= SanPhamEditViewHelper::e($old['mo_ta'] ?? $sanPham['mo_ta'] ?? '') ?></textarea>
                        <?php if (!empty($errors['mo_ta'])): ?><div class="text-danger small mt-1"><?= SanPhamEditViewHelper::e($errors['mo_ta']) ?></div><?php endif; ?>
                    </div>
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <?php if (!empty($errors['danh_muc_id'])): ?><div class="text-danger small mt-1"><?= SanPhamEditViewHelper::e($errors['danh_muc_id']) ?></div><?php endif; ?>
                    </div>
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <select class="form-select" id="trang_thai" name="trang_thai">
                            ...
                            ?>
                            <option value="CON_BAN" <?= $currentStatus === 'CON_BAN' ? 'selected' : '' ?>>Còn bán</option>
                            <option value="NGUNG_BAN" <?= $currentStatus === 'NGUNG_BAN' ? 'selected' : '' ?>>Ngừng bán</option>
                            <option value="SAP_RA_MAT" <?= $currentStatus === 'SAP_RA_MAT' ? 'selected' : '' ?>>Sắp ra mắt</option>
                            <option value="HET_HANG" <?= $currentStatus === 'HET_HANG' ? 'selected' : '' ?>>Hết hàng</option>
                        </select>
                        <?php if (!empty($errors['trang_thai'])): ?><div class="text-danger small mt-1"><?= SanPhamEditViewHelper::e($errors['trang_thai']) ?></div><?php endif; ?>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="form-check">
                            ...
                            ?>
                            <input class="form-check-input" type="checkbox" id="noi_bat" name="noi_bat" value="1" <?= $isChecked ? 'checked' : '' ?>>
