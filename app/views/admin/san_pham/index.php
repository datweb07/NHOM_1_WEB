                    ...
                    <div class="card-body">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="number" class="form-control" id="gia_min" name="gia_min" 
                                           value="<?= ($giaMin ?? null) !== null ? (int)$giaMin : '' ?>" 
                                           placeholder="0">
                                </div>
                                <div class="col-md-2">
                        ...
                        <?php if (($totalPages ?? 1) > 1): ?>
                            <nav aria-label="Page navigation" class="mt-3">
                                <ul class="pagination justify-content-center">
                                    <?php if (($currentPage ?? 1) > 1): ?>
                                        <li class="page-item">
                                            <a class="page-link" href="?page=<?= $currentPage - 1 ?>&keyword=<?= urlencode($keyword ?? '') ?>&danh_muc_id=<?= $danhMucId ?? '' ?>&gia_min=<?= $giaMin ?? '' ?>&gia_max=<?= $giaMax ?? '' ?>">
                                                Trước
                                            </a>
                                        </li>
                                    <?php endif; ?>
                                    ...
                                    <?php for ($i = 1; $i <= ($totalPages ?? 1); $i++): ?>
                                        <li class="page-item <?= $i === ($currentPage ?? 1) ? 'active' : '' ?>">
                                            <a class="page-link" href="?page=<?= $i ?>&keyword=<?= urlencode($keyword ?? '') ?>&danh_muc_id=<?= $danhMucId ?? '' ?>&gia_min=<?= $giaMin ?? '' ?>&gia_max=<?= $giaMax ?? '' ?>">
                                                <?= $i ?>
                                            </a>
                                        </li>
                                    <?php endfor; ?>
                            ...
                            <p class="text-center text-muted">
                                Hiển thị <?= (($currentPage ?? 1) - 1) * 20 + 1 ?> - <?= min(($currentPage ?? 1) * 20, $totalProducts ?? 0) ?> 
