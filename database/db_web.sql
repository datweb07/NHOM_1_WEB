...
CREATE TABLE `thanh_toan` (
  ...
  `phuong_thuc` enum('COD','CHUYEN_KHOAN','QR','TRA_GOP','VI_DIEN_TU','ZALOPAY','VIETQR','PAYPAL') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `transaction_log` (
  ...
  `gateway_name` enum('VNPAY','COD','REFUND','VIETQR','PAYPAL') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
